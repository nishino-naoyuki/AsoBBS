...
public class Digest {
	 ...
	 */
	public static String createPassword(String mailadress,String pwd) throws AsoBbsSystemErrException{
	 ...
	 * @throws AsoBbsSystemErrException
	 */
	public static String encNickName(String nickName,String maileAddress) throws AsoBbsSystemErrException{
	 ...
	 * @throws AsoBbsSystemErrException
	 */
	public static String decNickName(String nickName,String maileAddress) throws AsoBbsSystemErrException{
