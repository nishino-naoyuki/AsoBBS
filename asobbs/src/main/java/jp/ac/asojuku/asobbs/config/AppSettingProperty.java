...
public class AppSettingProperty extends ConfigBase {
	...
	private static final String BBS_UPLOAD_WK_DIR = "bbs.upload.work.directory";
	...
	public AppSettingProperty() throws AsoBbsSystemErrException {
		super();
	 ...
	 */
	public static AppSettingProperty getInstance() throws AsoBbsSystemErrException{
	...
	public String getBbsUploadWorkDirectory(){
		return getProperty(BBS_UPLOAD_WK_DIR);
	}
	/**
	 * シェルの実行パス
	 * @return
